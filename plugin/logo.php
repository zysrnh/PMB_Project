...
<li><a href="#"  onclick=bukajendela("bukti.php?id='.$nomorx.'")><i class="fa fa-print"></i> Bukti Pendaftaran</a></li>
	<li><a href="#"  onclick=bukajendela("usm.php?id='.$nomorx.'")><i class="fa fa-print"></i> Kartu USM</a></li>
