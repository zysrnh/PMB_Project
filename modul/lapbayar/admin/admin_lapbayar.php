...
$query = $koneksi_db->sql_query ("SELECT * FROM `mod_data_pmb` $strwhr  ORDER BY `id` ASC");
...
<td valign=top>'.$no.'.</td>
<td valign=top>'.datetimess($data['tanggal']).'</td>
<td valign=top>'.$data['nomor'].'</td>
<td valign=top>'.$data['nama'].'</td>
	<td>Rp. '.matauang($jumlah).'</td>
...
<td colspan=4>Total</td>
 ...
 echo '<tr><td colsapn=4> Tidak ada Transaksi</td></tr>';
 }
