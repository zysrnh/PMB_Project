...
Aspek Penilaian
  ...
  <a href="admin.php?pilih=aspek&amp;modul=yes">List Data</a> | 
  <a href="admin.php?pilih=aspek&amp;modul=yes&amp;action=add">Add Data</a> |
  <a href="admin.php?pilih=aspek&amp;modul=yes&amp;action=cari">Cari Data</a>
...
<input type="hidden" name="pilih" value="aspek" />
...
if (isset ($_POST['deleted'])){
	...
	foreach ($_POST['delete'] as $k=>$v){
		$query = $koneksi_db->sql_query ("DELETE FROM `mod_data_aspek` WHERE `id`='$v'");
	}
	}
...
$num = $koneksi_db->sql_query("SELECT `id` FROM `mod_data_aspek` $query_add");
...
$query = $koneksi_db->sql_query ("SELECT * FROM `mod_data_aspek` $query_add ORDER By `id` ASC LIMIT $offset, $limit");
...
<td>'.$data['bobot'].' %</td>
	...
	<td><a href="admin.php?pilih=aspek&amp;modul=yes&amp;action=edit&amp;id='.$id.'&amp;referer='.$referer.'">Edit</a></td>
...
if ($error != ''){
	...
	$insert = $koneksi_db->sql_query ("INSERT INTO `mod_data_aspek` (`bobot`,`nama`) VALUES ('$bobot','$nama')");
	if ($insert) {
...
<td>Bobot (%)</td>
<td>:</td>
<td>'.input_text ('bobot',@$_POST['bobot']).'</td>
</tr>
...
if ($error != ''){
	...
	$insert = $koneksi_db->sql_query ("UPDATE `mod_data_aspek` SET `nama`='$nama' WHERE `id` = '$id'");
	if ($insert) {
...
if (!isset ($_POST['submit'])){
$query = $koneksi_db->sql_query ("SELECT * FROM `mod_data_aspek` WHERE `id` = '$id'");
