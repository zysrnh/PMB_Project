...
Berkas Persyaratan
  ...
  <a href="admin.php?pilih=berkas&amp;modul=yes">List Data</a> | 
  <a href="admin.php?pilih=berkas&amp;modul=yes&amp;action=add">Add Data</a> |
  <a href="admin.php?pilih=berkas&amp;modul=yes&amp;action=cari">Cari Data</a>
...
<input type="hidden" name="pilih" value="berkas" />
...
if (isset ($_POST['deleted'])){
	...
	foreach ($_POST['delete'] as $k=>$v){
		$query = $koneksi_db->sql_query ("DELETE FROM `mod_data_berkas` WHERE `id`='$v'");
	}
	}
...
$num = $koneksi_db->sql_query("SELECT `id` FROM `mod_data_berkas` $query_add");
...
$query = $koneksi_db->sql_query ("SELECT * FROM `mod_data_berkas` $query_add ORDER By `id` ASC LIMIT $offset, $limit");
...
<td>'.$data['nama'].'</td>
	...
	<td><a href="admin.php?pilih=berkas&amp;modul=yes&amp;action=edit&amp;id='.$id.'&amp;referer='.$referer.'">Edit</a></td>
...
if ($error != ''){
	...
	$insert = $koneksi_db->sql_query ("INSERT INTO `mod_data_berkas` (`nama`) VALUES ('$nama')");
	if ($insert) {
...
if ($error != ''){
	...
	$insert = $koneksi_db->sql_query ("UPDATE `mod_data_berkas` SET `nama`='$nama' WHERE `id` = '$id'");
	if ($insert) {
...
if (!isset ($_POST['submit'])){
$query = $koneksi_db->sql_query ("SELECT * FROM `mod_data_berkas` WHERE `id` = '$id'");
