...
<tr><td>Berkas Pendaftaran diantar oleh</td><td>:</td><td>'.$oleh.'
...
<td>'.$getdata['email'].'</td>
	...
	<tr>
<td>Terima KPS</td><td>:</td><td>'.$kps.'</td></tr>
		<tr>
<td></td>
<td></td>
<td>'.$getdata['nokps'].'</td>
...
<tr><td>Jenis Kelas</td><td>:</td><td><select name="sumber" required>
			...
			<option value="Online">Onlinek</option>
			<option value="Offline">Offline</option>
			</select>
...
<td></td>
<td></td>
<td><input type="text" name="oleh2" value="'.$oleh2.'" placeholder="Nama Pengantar"></td>
</tr>
