...
<a href="index.php?pilih=guru&amp;modul=yes">List Data</a> | 

<a href="index.php?pilih=guru&amp;modul=yes&amp;action=cari">Cari Data</a>
...
$query = $koneksi_db->sql_query ("SELECT * FROM `mod_data_guru` ORDER By `id` ASC LIMIT $offset, $limit");
