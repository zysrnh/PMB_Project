...
if ($error != ''){
	...
	$insert = $koneksi_db->sql_query ("UPDATE `mod_data_profil` SET `nama`='$nama',`alamat`='$alamat',`email`='$email',`telp`='$telp',`fax`='$fax',`wa`='$wa',`desc`='$desc',`fb`='$fb',`tw`='$tw',`in`='$in',`slogan`='$slogan',`slogan2`='$slogan2',`sambutan`='$sambutan',`tele`='$tele',`foto`='$foto',`foto2`='$foto2',`top`='$top',`warnah`='$warnah'
,`warnaf`='$warnaf'
,`warnaf2`='$warnaf2' WHERE `id` = '1'");
	if ($insert) {
...
<tr>
<td><br/><b>Konfigurasi<br/><br/></b></td>
<td></td>
<td></td>
</tr>
