...
$query         = $koneksi_db->sql_query ("SELECT user,password,level,email FROM pengguna WHERE user='$user' AND password='$password' AND tipe='aktif' AND level='User' OR  user='$user' AND password='$password' AND tipe='aktif' AND level='Editor' OR  user='$user' AND password='$password' AND tipe='aktif' AND level='PMB' ");
