...
foreach ($platforms as $key => $val)
{
    ...
    elseif((preg_match("/bot/i", $agent)) || (preg_match("/Google/i", $agent)) || (preg_match("/Slurp/i", $agent)) || (preg_match("/Scooter/i", $agent)) || (preg_match("/Spider/i", $agent)) || (preg_match("/Infoseek/i", $agent))) $browser =8;   //"Bot";
    else $browser =9;   
